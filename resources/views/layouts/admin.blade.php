        ...
        <div class="row">
            ...
            <div class="col-12 col-md-3 mb-4">
                <div class="list-group">
                    ...
                    <a href="{{ route('policy_admin')}}" class="list-group-item d-flex justify-content-center align-items-center"><i class="fa-solid fa-lock me-2"></i></i>Polityka prywatności</a>
                    <a href="{{ route('return_admin')}}" class="list-group-item d-flex justify-content-center align-items-center"><i class="fa-solid fa-right-left me-2"></i></i>Zwroty i reklamacje</a>
                </div>
            </div>
            <!--END NAVIGATION SIDE-->
            <!--MAIN SIDE-->
