    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-7">
                <form class="form text-center my-4" action="{{route('user.order.store')}}" method="POST">
                    <!--TOKEN-->
                    @csrf
                    ...
                    <button class="btn btn-custom-4 my-4" type="submit"><i class="fa-solid fa-credit-card me-2"></i>Kupuję i płacę</button>
                    <a href="{{route('user.busket')}}" class="btn btn-danger my-4" type="button"><i class="fa-solid fa-xmark me-2"></i>Anuluj</a>
                </form>
            </div>
