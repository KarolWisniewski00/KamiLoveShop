    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <div class="mb-3"><a href="{{route('user.order')}}"><span class="badge rounded-pill bg-custom"><i class="fa-solid fa-chevron-left me-2"></i>Powrót</span></a></div>
                <div class="my-4">
            ...
            <div class="d-flex justify-content-start align-items-center mt-4">
                <a href="{{route('user.order')}}" class="btn btn-custom"><i class="fa-solid fa-chevron-left me-2"></i>Pwrót</a>
            </div>
        </div>
    </div>
</section>
