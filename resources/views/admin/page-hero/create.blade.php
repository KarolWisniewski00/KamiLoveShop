...
<div class="row mb-3">
    <div class="col-12">
        <div class="d-flex flex-row justify-content-start align-items-center">
            ...
            <span class="badge rounded-pill bg-primary">Whybrano: Tworzenie nowego hero</span>
        </div>
    </div>
    <hr>
    ...
    <div class="col-12">
        <form method="POST" action="{{route('admin.page-hero.store')}}">
            @csrf
            <div class="form-floating my-3 w-100">
                <input type="text" class="form-control" id="h1" value="{{ old('h1') }}" name="h1" required>
                <label for="h1">Tytuł</label>
                <span class="text-danger">@error('h1') {{$message}} @enderror</span>
            </div>

            <div class="form-floating my-3 w-100">
                <input type="text" class="form-control" id="p" value="{{ old('p') }}" name="p" required>
                <label for="p">paragraf</label>
                <span class="text-danger">@error('p') {{$message}} @enderror</span>
            </div>

            <div class="form-floating my-3 w-100">
                <input type="text" class="form-control" id="button" value="{{ old('button') }}" name="button" required>
            ...
            <div class="d-flex justify-content-start align-items-center mt-4">
                ...
                <a href="{{route('admin.page-hero')}}" class="btn btn-danger btn-lg"><i class="fa-solid fa-xmark"></i> Anuluj</a>
            </div>
        </form>
    </div>
</div>
