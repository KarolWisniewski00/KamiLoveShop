...
<div class="row mb-3">
    <div class="col-12">
        <div class="d-flex flex-row justify-content-start align-items-center">
            ...
            <span class="badge rounded-pill bg-primary">Wybrano: Edytownie rozmiaru</span>
        </div>
    </div>
    <hr>
    ...
    <div class="col-12">
        <form method="POST" action="{{route('admin.size.update', $siz->id)}}">
            <!--TOKEN-->
            @csrf
            @method('PUT')
            <div class="form-floating my-3 w-100">
                <input type="text" class="form-control" id="value" value="{{$siz->value}}" name="value" required>
