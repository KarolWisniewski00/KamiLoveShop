...
<div class="row mb-3">
    <div class="col-12">
        <div class="d-flex flex-row justify-content-start align-items-center">
            ...
            <span class="badge rounded-pill bg-primary">Wybrano: Tworzenie nowego zdjęcia</span>
        </div>
    </div>
    <hr>
